...
const UserController = {
    ...
    add: async (req, res) => {
        // console.log(req.body,req.file)
        const { username, introduction, roleId: role, password, region, roleState,roleName } = req.body
        const avatar = req.file ? `/avataruploads/${req.file.filename}` : ""
        await UserService.add({ username, introduction, avatar, role, password, region, roleState,roleName })
        res.send({
            ActionType: "OK",
        })
    },
